...
public class Movement2 : MonoBehaviour
{
    ...
    public float sprintSpeed = 5f; // Speed while sprinting
    public float acceleration = 100f; // How quickly to reach the target speed
    public float deceleration = 1000f; // How quickly to come to a stop
